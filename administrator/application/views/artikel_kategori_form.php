...
<head>
    <meta charset="utf-8">
    <title>Artikel Kategori form</title>
    <style type="text/css">
        html, body {
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-6 col-md-6">
                    <button style="width: 100%;" type="button" class="btn btn-default bg-aqua-gradient" onclick="move_url('artikel_kategori');">Lihat Data</button>
                </div>
            </div>
