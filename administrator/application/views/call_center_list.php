            ...
            <div class="col-lg-12 col-lg-12a">
                <div class="panel panel-success">
                    ...
                    <div class="panel-heading bg-light-blue-gradient" style="padding-bottom: 10px; color: white;">
                        List Call Center                        
                        <a id="addData" href="../../../index.php/call_center/add" class="btn btn-primary btn-xs pull-right hidden-xs bg-green-gradient"><span class="glyphicon glyphicon-plus"></span>&nbsp;New Call Center</a>
                    </div>
                    <table id="table-data" class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th>Id</th>                                                                                                
                                <th>Judul Call Center</th>                                                                                                
                                <th>Nomor Call Center</th>                                                                                                                                                                                                
                                <th>Action</th>
                            </tr>
                        </thead>
                        <tbody>
