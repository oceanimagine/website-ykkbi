            ...
            <div class="col-lg-12 col-lg-12a">
                <div class="panel panel-success">
                    ...
                    <div class="panel-heading bg-light-blue-gradient" style="padding-bottom: 10px; color: white;">
                        List Artikel Kategori                        
                        <a id="addData" href="../../../index.php/artikel_kategori/add" class="btn btn-primary btn-xs pull-right hidden-xs bg-green-gradient"><span class="glyphicon glyphicon-plus"></span>&nbsp;New Artikel Kategori</a>
                    </div>
