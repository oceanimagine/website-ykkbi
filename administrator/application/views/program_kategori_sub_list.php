...
<head>
	<meta charset="utf-8">
	<title>Program Kategori Sub List</title>
        <style type="text/css">
            html, body {
            ...
            <div class="col-lg-12 col-lg-12a">
                <div class="panel panel-success">
                    ...
                    <div class="panel-heading bg-light-blue-gradient" style="padding-bottom: 10px; color: white;">
                        List Program Kategori Sub                        
                        <a id="addData" href="../../../index.php/program_kategori_sub/add" class="btn btn-primary btn-xs pull-right hidden-xs bg-green-gradient"><span class="glyphicon glyphicon-plus"></span>&nbsp;New Program Kategori Sub</a>
                    </div>
                    <table id="table-data" class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th>Id</th>                                                                                                
                                <th>Program Kategori Induk</th>                                                                                                
                                <th>Judul Kategori Sub</th>                                                                                                                                
                                <th>Action</th>
                            </tr>
                        </thead>
                        <tbody>
