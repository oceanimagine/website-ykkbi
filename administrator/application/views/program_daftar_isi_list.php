...
<head>
	<meta charset="utf-8">
	<title>Program Daftar Isi List</title>
        <style type="text/css">
            html, body {
            ...
            <div class="col-lg-12 col-lg-12a">
                <div class="panel panel-success">
                    ...
                    <div class="panel-heading bg-light-blue-gradient" style="padding-bottom: 10px; color: white;">
                        List Program Daftar Isi                        
                        <a id="addData" href="../../../index.php/program_daftar_isi/add" class="btn btn-primary btn-xs pull-right hidden-xs bg-green-gradient"><span class="glyphicon glyphicon-plus"></span>&nbsp;New Program Daftar Isi</a>
                    </div>
                    <table id="table-data" class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th>Id</th>                                                                                                
                                <th>Program Kategori Sub</th>                                                                                                
                                <th>Judul Daftar Isi</th>                                                                                                                                
                                <th>Action</th>
                            </tr>
                        </thead>
                        <tbody>
