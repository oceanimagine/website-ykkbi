...
<head>
	<meta charset="utf-8">
	<title>Program Kategori Induk List</title>
        <style type="text/css">
            html, body {
            ...
            <div class="col-lg-12 col-lg-12a">
                <div class="panel panel-success">
                    ...
                    <div class="panel-heading bg-light-blue-gradient" style="padding-bottom: 10px; color: white;">
                        List Program Kategori Induk                        
                        <a id="addData" href="../../../index.php/program_kategori_induk/add" class="btn btn-primary btn-xs pull-right hidden-xs bg-green-gradient"><span class="glyphicon glyphicon-plus"></span>&nbsp;New Program Kategori Induk</a>
                    </div>
