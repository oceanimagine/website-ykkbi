...
<head>
	<meta charset="utf-8">
	<title>Tentang Profile Pengurus List</title>
        <style type="text/css">
            html, body {
            ...
            <div class="col-lg-12 col-lg-12a">
                <div class="panel panel-success">
                    ...
                    <div class="panel-heading bg-light-blue-gradient" style="padding-bottom: 10px; color: white;">
                        List Profile Pengurus                        
                        <a id="addData" href="../../../index.php/tentang_profile_pengurus/add" class="btn btn-primary btn-xs pull-right hidden-xs bg-green-gradient"><span class="glyphicon glyphicon-plus"></span>&nbsp;New Tentang Profile Pengurus</a>
                    </div>
