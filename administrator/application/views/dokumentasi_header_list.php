...
<head>
	<meta charset="utf-8">
	<title>Dokumentasi Header List</title>
        <style type="text/css">
            html, body {
            ...
            <div class="col-lg-12 col-lg-12a">
                <div class="panel panel-success">
                    ...
                    <div class="panel-heading bg-light-blue-gradient" style="padding-bottom: 10px; color: white;">
                        List Dokumentasi Header                        
                        <a id="addData" href="../../../index.php/dokumentasi_header/add" class="btn btn-primary btn-xs pull-right hidden-xs bg-green-gradient"><span class="glyphicon glyphicon-plus"></span>&nbsp;New Dokumentasi Header</a>
                    </div>
                    <table id="table-data" class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th>Id</th>                                                                                                
                                <th>Judul Event</th>                                                                                                
                                <th>Photo Dokumentasi Header</th>                                                                                                
                                <th>Tanggal Mulai</th>                                                                                                
