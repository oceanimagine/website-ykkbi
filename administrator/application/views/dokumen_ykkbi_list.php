...
<head>
	<meta charset="utf-8">
	<title>Dokumen YKKBI List</title>
        <style type="text/css">
            html, body {
            ...
            <div class="col-lg-12 col-lg-12a">
                <div class="panel panel-success">
                    ...
                    <div class="panel-heading bg-light-blue-gradient" style="padding-bottom: 10px; color: white;">
                        List Dokumen                        
                        <a id="addData" href="../../../index.php/dokumen_ykkbi/add" class="btn btn-primary btn-xs pull-right hidden-xs bg-green-gradient"><span class="glyphicon glyphicon-plus"></span>&nbsp;New Dokumen</a>
                    </div>
