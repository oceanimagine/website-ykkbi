        ...
        <div class="col-md-12 col-sm-12 col-xs-12" style="padding-right: 0px; padding-left: 0px;">
            <div style=" width: 100%; height: 100%; background-color: #f1f1f1; padding: 0.01em 16px; border-radius: 0px; margin-left: auto; margin-right: auto; padding-top: 15px; padding-bottom: 15px; box-shadow: 0 4px 14.48px rgb(0 0 0 / 25%); z-index: 99; position: relative;">
                <div class="header_article" style="background-color: #3b3c8c; width: 100%; padding: 8px 16px; border-radius: 4px;">
                    <h3 style='color: white; margin-bottom: 2px; text-align: center;'>Galeri YKKBI</h3>
                </div>
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="row" style="padding-bottom: 4px;">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <table border="0" cellspacing="0" cellpadding="0" style="width: 100%;">
                                    <tr>
                                        <td style="width: 90%;">
                                            <input placeholder="Cari Galeri" type="text" style="height: 38px; padding: 10px; width: 100%; border-bottom-right-radius: 0px; border-top-right-radius: 0px; border-bottom-left-radius: 12px; border-top-left-radius: 12px;" class="form-control" />
                                        </td>
                                        <td style="width: 10%;">
                        ...
                        <section id="article" style="background-color: #f1f1f1; padding-bottom: 0px; padding-top: 16px; position: relative; z-index: 99;">
                            <div class="row">
                                ...
                                $query_galeri_header = mysqli_query($connect, "SELECT * FROM `tbl_galeri_header` order by timestamp desc limit 0, 30");
                                $jumlah_galeri_header = mysqli_num_rows($query_galeri_header);
                                if($jumlah_galeri_header > 0){
                                    $limit_galeri_header_row = 3;
                                    $page_galeri_header_row_ = ceil($jumlah_galeri_header / $limit_galeri_header_row);
                                    $rest_galeri_header_row_ = $jumlah_galeri_header - (($page_galeri_header_row_ - 1) * $limit_galeri_header_row);
                                    $rest_hold = 0;
                                    $data_count = 0;
                                    while($hasil_galeri_header = mysqli_fetch_array($query_galeri_header)){
                                        if($jumlah_galeri_header - $data_count == $rest_galeri_header_row_){
                                            $rest_hold = 1;
                                        }
                                        if($limit_galeri_header_row == 4){
                                            $class_ = "col-md-3 col-sm-6 ";
                                        }
                                        if($limit_galeri_header_row == 3){
                                            $class_ = "col-md-4 col-sm-6 ";
                                        }
                                        if($rest_hold){
                                            if($rest_galeri_header_row_ == 4){
                                                $class_ = "col-md-3 col-sm-6 ";
                                            }
                                            if($rest_galeri_header_row_ == 3){
                                                $class_ = "col-md-4 col-sm-6 ";
                                            }
                                            if($rest_galeri_header_row_ == 2){
                                                $class_ = "col-md-6 col-sm-6 ";
                                            }
                                            if($rest_galeri_header_row_ == 1){
                                                $class_ = "col-md-12 col-sm-12 ";
                                            }
                                        }
                                        if($hasil_galeri_header['photo_galeri_header'] != "" && file_exists(__DIR__ . "/../upload/photo_galeri_header/" . $hasil_galeri_header['photo_galeri_header'])){
                                            $src_ = "upload/photo_galeri_header/" . $hasil_galeri_header['photo_galeri_header'];
                                        ...
                                        $timestamp_ = $hasil_galeri_header['timestamp'];
                                                ...
                                                <div class="card" style="min-height: 400px;">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="desc-article">
                                                            <span
                                                                class="d-block mb-2">
                                                                <strong style="display: -webkit-box; -webkit-line-clamp: 1; -webkit-box-orient: vertical; overflow: hidden;"><?php echo $hasil_galeri_header['judul_galeri']; ?></strong>
                                                            </span>
                                                            <span class="text-secondary small"><?php echo $all_day; ?></span>
                                                            <div class="limit-text-dashboard">
                                                                <?php echo substr(strip_tags($hasil_galeri_header['deskripsi_singkat']), 0, 200); ?>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
