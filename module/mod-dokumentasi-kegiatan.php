                        ...
                        <section id="article" style="background-color: #f1f1f1; padding-bottom: 0px; padding-top: 16px; position: relative; z-index: 99;">
                            <div class="row">
                                ...
                                if(isset($_GET['search']) && $_GET['search'] != ""){
                                    ...
                                    $where_search = " where judul_event like '%" . strtolower(str_replace(array_reverse($GLOBALS['replace']),array_reverse($GLOBALS['search']), strip_tags($search))) . "%' or deskripsi_singkat like '%" . strtolower(str_replace(array_reverse($GLOBALS['replace']),array_reverse($GLOBALS['search']), strip_tags($search))) . "%'";
                                }
                                
                                $query_dokumentasi_header = mysqli_query($connect, "SELECT * FROM `tbl_dokumentasi_header` ".$where_search." order by timestamp desc limit 0, 30");
                                        ...
                                        <div class="<?php echo $class_; ?> col-xs-12">
                                            <a href="#" style="pointer-events: none; cursor: default;">
                                                <div class="card" style="height: 435px;">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="title-article" style="white-space: nowrap;">
                                                            <span>
